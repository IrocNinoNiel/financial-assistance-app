...
export const VALIDATION_MESSAGES = {
    ...
    SPONSORSHIP_FILTER_DURATION_FROM_INVALID: "duration_from must be a valid ISO 8601 date",
    SPONSORSHIP_FILTER_DURATION_TO_INVALID: "duration_to must be a valid ISO 8601 date",
    ...
    APP_STAGE_PARAM_INVALID: "Invalid applicationStage. Allowed values are: POOLING | APPLICATION_LIST | RANKING_SELECTION | FINAS_PROPER",
    APP_STAGE_REQUIRED: "appStage is required",
    APP_STATUS_REQUIRED: "appStatus is required",
    APP_STAGE_INVALID: "Invalid appStage. Allowed values are: POOLING | APPLICATION_LIST | RANKING_SELECTION | FINAS_PROPER",
